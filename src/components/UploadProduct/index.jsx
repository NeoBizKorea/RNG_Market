  ...
  const onSubmit = async () => {
		...
		if (selectedFile !== null) {
			try {
				...
				const file2: any = new Moralis.File(`${itemName}metadata.json`, {
				...
				await axios.post(
					`${process.env.REACT_APP_BASE_URL}/api/nft/create`,
					body,
					{
				...
				alert(
					`NFT successfully minted. addr: ${contractAddress} and tokenId: ${tokenId}`
				);
				navigate("/");
			} catch (err) {
				console.log(err);
            ...
            <div className="w-full">
              ...
              <div className="w-full bg-white section-shadow rounded-2xl">
                ...
                <div className="main-content w-full lg:flex justify-between lg:px-9 px-4">
                  ...
                  <div className="w-[1px] bg-light-purple" />
