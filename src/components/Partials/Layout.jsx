...
import { changeToggleStatus, selectCurrentToggleStatus } from "../../store/toggleStatus/toggleStatus";
...
export default function Layout({ children }) {
  ...
  const currentToggleStatus = useAppSelector(selectCurrentToggleStatus);
        ...
        <div className="nft-wrapper-layout-container 2xl:pr-20 md:pr-10 pr-2 pl-2 md:pl-0 w-full min-h-screen flex">
          ...
          >
            <Sidebar
              ...
              sidebar={currentToggleStatus.toggle}
              action={() => dispatch(changeToggleStatus({ toggle: !currentToggleStatus.toggle }))}
            />
          </div>
          {MobileSideBar && (
            <div
              onClick={() => dispatch(changeToggleStatus({ toggle: !currentToggleStatus.toggle }))}
