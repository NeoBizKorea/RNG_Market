...
export default function ProductCardStyleOne({ datas, hidden = false, NFTBalance }) {
  ...
  return (
    <div className="card-style-one flex flex-col justify-between w-full h-[250px] bg-white p-3 pb rounded-2xl">
      <div className="content">
        ...
        <div className="w-full h-40">
          ...
          <div
            ...
            style={{
              background: `url(${datas?.metadata?.image}) 0% 0% / cover no-repeat`,
            }}
          >
        ...
        <div className="details">
          ...
          {/* <div className="w-full h-[54px] flex justify-evenly items-center p-2 rounded-lg border border-[#E3E4FE]">
            ...
            <div className="w-[1px] h-full bg-[#E3E4FE]" />
            <div className="flex flex-col justify-between">
              <p className="text-sm text-thin-light-gray tracking-wide">
                Remaing Time
              </p>
