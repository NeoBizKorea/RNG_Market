...
export default function OverviewSection({ className, currentNft, approveAll, setPrice, price }) {
    ...
    <>
      <div className={`overview-section w-full ${className || ""}`}>
        <div className="overview-section-wrapper lg:flex lg:h-[494px] lg:pace-x-2">
          ...
          <div className="overview-countdown lg:w-2/5 w-full h-full flex flex-col lg:pl-11 lg:py-16">
            <div className="mb-5">
              <h1 className="text-2xl font-bold text-dark-gray tracking-wide">
              {currentNft?.metadata?.itemName}
              </h1>
              <span className="text-[18px] font-thin tracking-wide text-dark-gray">
                ID : {currentNft?.token_hash}
              </span>
              <span className="text-[18px] font-thin tracking-wide text-dark-gray">
                NFT 설명 : {currentNft?.metadata?.description}
              </span>
            </div>
            {/* user */}
            ...
            {/* <div className="w-full h-32 flex justify-evenly items-center p-6 rounded-2xl border border-[#d3d2fe] lg:mb-0 mb-3">
              ...
              <div className="w-[1px] h-full bg-[#d3d2fe]" />
              <div className="flex flex-col justify-between">
                <p className="text-base text-dark-gray tracking-wide">
                  Remaing Time
                </p>
            ...
            <div className="flex space-x-3 items-center">
              <input type="text" className="w-full h-10 rounded-2xl border border-[#d3d2fe] p-2 mb-5" placeholder="Enter your bid" value={price} onChange={(e) => setPrice(e.target.value)} />
            </div>
            <div className="flex space-x-3 items-center">
              <button
